<%@ Page Language="C#" MasterPageFile="~/MasterPage/WebShopMaster.master" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Login" Title="Web Shop Module Login" %>
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
     <ContentTemplate>
        ...
        <div id="AccLogContainer" class="accountlogcontainer">
            <div id="AccountPanel" class="accountpaneldiv accpanelmargin" >
                <div id="AccPanelHeader" class="panelheader">
                  <label>Ik wil een account aanvragen</label>
                </div> 
                <div id="AccPanelContent" class="panelcontentcolor">
                    <div class="panelcontentmargin">
                        <div class="panelcontentheader">
                            <label>Geef hier uw gegevens op indien u nog geen account heeft.</label>
                        </div>
                        <div class="panelcontentheader">
                        ...
                        <div class="panelcontrolscontainer">
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtCompanyName" runat="server" Width="165px" MaxLength="50"></asp:TextBox>
                            ...
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtContactPerson" runat="server" Width="165px" MaxLength="80"></asp:TextBox>
                            ...
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtPhoneNo" MaxLength="15" runat="server" Width="165px"></asp:TextBox>
                            ...
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtEmail" runat="server" Width="165px" MaxLength="255"></asp:TextBox>
                        ...
                        <div class="accbtn">
                            <asp:Button ID="btnAccount" runat="server" Text="Account aanvragen" Width="146px"
                                onclick="btnAccount_Click" ValidationGroup="AccountValidation" />                      
                        </div>
                    </div>
                </div>             
            </div>
            <div id="LoginPanel" class="accountpaneldiv logpanelmargin">
                ...
                <div id="LogPanelContent" class="panelcontentcolor">
                    <div class="panelcontentmargin">
                        <div class="panelcontentheader">
                            <label>Indien u al een account heeft bij luchttechnisch Buro Hey BV,<br /> 
                             dan kunt u deze hier invoeren om in te loggen.</label>
                        </div>                 
                        <div class="panelcontrolscontainer logincontrolpadding">
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtUserName" runat="server" Width="165px" MaxLength="255"></asp:TextBox>
                            ...
                            <div class="panelcontroldiv">
                                ...
                                <div class="panelcontroltextbox">
                                    <asp:TextBox ID="txtPassword" runat="server" Width="165px" MaxLength="20" 
